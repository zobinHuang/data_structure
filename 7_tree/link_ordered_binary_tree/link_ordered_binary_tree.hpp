    ...
    order_tree<DATATYPE>(){
        ...
        while(root == nullptr){
            ...
            if(input != -1){
                ...
                cout << "root value is -1, can't created an empty order tree!" << endl;
            }
        }
    }
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::insert(DATATYPE new_data){
    if(root == nullptr){
        cout << "root is nullptr, can't insert!" << endl;
    }
    else if(new_data == -1){
        cout << "try to insert value -1, ignore!" << endl;
    }else{
        tnode<DATATYPE>* new_node = new tnode<DATATYPE>(new_data);
        if(new_node == nullptr){
            cout << "error occurs while allocating space for order_tree node" << endl;
        }else{
            /*有序插入的逻辑*/
            tnode<DATATYPE>* p = root;
            while(1){
                if(p->get_value()>new_data){
                    if(p->get_Lchild() == nullptr){
                        p->set_Lchild(new_node);
                        break;
                    }else{
                        p = p->get_Lchild();
                    }
                }else{
                    if(p->get_Rchild() == nullptr){
                        p->set_Rchild(new_node);
                        break;
                    }else{
                        p = p->get_Rchild();
                    }
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::pre_order_traversal_stack(){
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::in_order_traversal_stack(){
    stack<tnode<DATATYPE>*>* traversal_stack = new stack<tnode<DATATYPE>*>();
    tnode<DATATYPE>* p = root;
    while( p != nullptr || !traversal_stack->empty()){
        if(p != nullptr){
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::post_order_traversal_stack(){
    stack<tnode<DATATYPE>*>* traversal_stack = new stack<tnode<DATATYPE>*>();
    tnode<DATATYPE>* p = root;
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::pre_order_traversal_recursion(){
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::in_order_traversal_recursion(){
 ...
 */
template <class DATATYPE>
void order_tree<DATATYPE>::post_order_traversal_recursion(){
